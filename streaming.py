...
for (k,v) in stocks_dic.items():
    if (tickerSymbol.upper()==k):
        ...
        fig=px.bar(d4,x='month',y='count',color='verdict',animation_frame='year',animation_group='verdict',range_y=[0,40],template='plotly_dark',labels={'count':'Number of Analysts who think you should do this'},barmode='relative',text='count',title="Number of Analysts Recommendations by Recommendation Type in the Current Year ")
